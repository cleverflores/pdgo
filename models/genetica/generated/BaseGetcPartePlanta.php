 ...
 * @property string $de_parte_planta
 ...
 */
abstract class BaseGetcPartePlanta extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('getc_parte_planta');
        ...
        $this->hasColumn('de_parte_planta', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'primary' => false,
