 ...
 */
abstract class BaseMdlRoleCapabilities extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('mdl_role_capabilities');
        ...
        $this->hasColumn('capability', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'primary' => false,
        ...
        $this->hasColumn('permission', 'integer', 8, array(
             'type' => 'integer',
             'length' => 8,
             'unsigned' => 0,
             'primary' => false,
