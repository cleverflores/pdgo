 ...
 */
abstract class BaseMdlCourseCategories extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('mdl_course_categories');
        ...
        $this->hasColumn('coursecount', 'integer', 8, array(
             'type' => 'integer',
             'length' => 8,
             'unsigned' => 1,
             'primary' => false,
