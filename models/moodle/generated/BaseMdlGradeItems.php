 ...
 */
abstract class BaseMdlGradeItems extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('mdl_grade_items');
        ...
        $this->hasColumn('display', 'integer', 8, array(
             'type' => 'integer',
             'length' => 8,
             'unsigned' => 0,
             'primary' => false,
        ...
        $this->hasColumn('decimals', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             'unsigned' => 1,
             'primary' => false,
